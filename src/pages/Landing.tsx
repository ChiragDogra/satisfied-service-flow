      ...
      <section className="relative overflow-hidden bg-gradient-hero py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tight text-primary-foreground leading-tight">
              Professional IT Services You Can Trust
            </h1>
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-primary-foreground/90 px-2">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6 px-4">
              <Button asChild size="xl" variant="secondary" className="shadow-xl w-full sm:w-auto min-h-[48px]">
                <Link to="/request">Request Service Now</Link>
              </Button>
              <Button asChild variant="outline" size="xl" className="bg-primary-foreground/10 text-primary-foreground border-primary-foreground hover:bg-primary-foreground hover:text-primary w-full sm:w-auto min-h-[48px]">
          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
            {trustIndicators.map((item, index) => (
              <div key={index} className="text-center">
                <div className="mx-auto flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-primary/10">
      ...
      <section className="py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:scale-105 border-border/40">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 mb-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 group-hover:bg-primary group-hover:text-primary-foreground transition-colors flex-shrink-0">
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <Button asChild size="lg" variant="hero" className="shadow-xl min-h-[48px] w-full sm:w-auto">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-3">
            <div className="text-center p-4">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">(555) 123-TECH</p>
            ...
            <div className="text-center p-4">
              ...
              <p className="text-muted-foreground text-sm sm:text-base break-all">service@satisfiedcomputers.com</p>
            ...
            <div className="text-center p-4">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">123 Tech Street</p>
